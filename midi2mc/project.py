...
def load_project_namespace(project_path: Path, cli_args: Namespace | None = None) -> Namespace:
    ...
    namespace = Namespace(
        ...
        stage_template=_get(data, "stage_template", "pulse"),
        module_hold_ticks=int(_get(data, "module_hold_ticks", 0) or 0),
        ...
        fx_profile=_get(data, "fx_profile", "concert"),
        fx_intensity=float(_get(data, "fx_intensity", 1.0) or 1.0),
        fx_layers=str(_get(data, "fx_layers", "all") or "all"),
